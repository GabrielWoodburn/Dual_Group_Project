	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (act == null) {
			...
			try {
				...
				request.setAttribute("month", listToEdit.getAnimalDate().getMonthValue());
				request.setAttribute("date", listToEdit.getAnimalDate().getDayOfMonth());
				request.setAttribute("year", listToEdit.getAnimalDate().getYear());
